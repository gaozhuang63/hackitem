...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MsgBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MsgBox_t qt_meta_stringdata_MsgBox = {
    {
QT_MOC_LITERAL(0, 0, 6), // "MsgBox"
QT_MOC_LITERAL(1, 7, 11), // "okBtn_press"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 15), // "cancleBtn_press"
QT_MOC_LITERAL(4, 36, 14) // "closeBtn_press"

    },
    "MsgBox\0okBtn_press\0\0cancleBtn_press\0"
    "closeBtn_press"
};
...
void MsgBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->okBtn_press(); break;
        case 1: _t->cancleBtn_press(); break;
        case 2: _t->closeBtn_press(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject MsgBox::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_MsgBox.data,
    qt_meta_data_MsgBox,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *MsgBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MsgBox.stringdata0))
